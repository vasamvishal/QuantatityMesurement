...
let QuantityMeasurement = require("../QuantityMeasurement/QuantityMeasurement");
let EnumTypes = require("../QuantityMeasurement/UnitType");

describe("test cases for 1 inch is equal 12 feets", () => {

    it("given 1 Inch and 1 Inch should return true", () => {
        let inchObject = new QuantityMeasurement(1.0, EnumTypes.LENGTH.INCHES);
        let inchObject1 = new QuantityMeasurement(1.0, EnumTypes.LENGTH.INCHES);
    ...
    it("given 1 Feet and 1 Feet should return true", () => {
        ...
        let feetObject1 = new QuantityMeasurement(1.0, EnumTypes.LENGTH.FEET);
    ...
    it("given null and 1 Inches should return false", () => {
        let inchObject = new QuantityMeasurement(null,EnumTypes.LENGTH.INCHES);
        let inchObject1 = new QuantityMeasurement(1.0, EnumTypes.LENGTH.INCHES);
        let result = inchObject1.checkEquality(inchObject, inchObject1);
        assert.equal(result, false);
    });
    ...
    it("given 1 Feet and 12 Inches should return true", () => {
        let inchObject = new QuantityMeasurement(12.0, EnumTypes.LENGTH.INCHES);
        let feetObject = new QuantityMeasurement(1.0, EnumTypes.LENGTH.FEET);
    ...
    it("given 1 Feet with null values and 12 Inches should return false", () => {
        let inchObject = new QuantityMeasurement(12.0, EnumTypes.LENGTH.INCHES);
        let feetObject = new QuantityMeasurement(null, EnumTypes.LENGTH.FEET);
...
describe("test cases for 3 feet is equal 1 yard", () => {
    ...
    it("given 3 Feet and 1 Yard should return true", () => {
        let inch = new QuantityMeasurement(3.0, EnumTypes.LENGTH.FEET);
        let yard = new QuantityMeasurement(1.0, EnumTypes.LENGTH.YARD);
        let result = inch.compare(inch, yard);
        assert.equal(result, true);
    });

    it("given 1 Feet and 1 Yard should return false", () => {
        let feet = new QuantityMeasurement(1.0, EnumTypes.LENGTH.FEET);
        let yard = new QuantityMeasurement(1.0, EnumTypes.LENGTH.YARD);
    ...
    it("given 1 inch and 1 Yard should return false", () => {
        let inch = new QuantityMeasurement(1.0, EnumTypes.LENGTH.INCHES);
        let yard = new QuantityMeasurement(1.0, EnumTypes.LENGTH.YARD);
    ...
    it("given 1 Yard and 36 inches should return true", () => {
        let inch = new QuantityMeasurement(36.0, EnumTypes.LENGTH.INCHES);
        let yard = new QuantityMeasurement(1.0, EnumTypes.LENGTH.YARD);
        let result = yard.compare(yard, inch);
        assert.equal(result, true);
    });
    ...
    it("given 1 Inch and 2 Inch  should return false", () => {
        let yard = new QuantityMeasurement(1.0, EnumTypes.LENGTH.INCHES);
        let inch = new QuantityMeasurement(2.0, EnumTypes.LENGTH.INCHES);
        let result = inch.compare(inch, yard);
        assert.equal(result, false);
    });
    ...
    it("given 1 Yard and 3 Feet should return true", () => {
        let yard = new QuantityMeasurement(1.0, EnumTypes.LENGTH.YARD);
        let feet = new QuantityMeasurement(3.0, EnumTypes.LENGTH.FEET);
    ...
    it("given 2 Inches and 5 Centimetre should return true", () => {
        let inch = new QuantityMeasurement(2.0, EnumTypes.LENGTH.INCHES);
        let Centimetre = new QuantityMeasurement(5.0, EnumTypes.LENGTH.CENTIMETER);
    ...
    it("given 2 Inches and 2 Inch should return 4 Inch", () => {
        let inch = new QuantityMeasurement(2.0, EnumTypes.LENGTH.INCHES);
        let inch1 = new QuantityMeasurement(2.0, EnumTypes.LENGTH.INCHES);
    ...
    it("given 2 Inches and 2 Litres should return 4 Inch", () => {
        let inch = new QuantityMeasurement(2.0, EnumTypes.LENGTH.INCHES);
        let inch1 = new QuantityMeasurement(2.0, EnumTypes.VOLUME.LITRES);
        let additionResult = inch.addition(inch, inch1);
    ...
    it("given 1 Feet 1 Feet should return 24 Inch", () => {
        let feet = new QuantityMeasurement(1.0, EnumTypes.LENGTH.FEET);
        let feet1 = new QuantityMeasurement(1.0, EnumTypes.LENGTH.FEET);
    ...
    it("given 2 Inch and 2.5 centimetre should return 3 Inch", () => {
        let inch = new QuantityMeasurement(2.0, EnumTypes.LENGTH.INCHES);
        let centimetre = new QuantityMeasurement(2.5, EnumTypes.LENGTH.CENTIMETER);
...
describe("test cases for volume in gallons ", () => {
    ...
    it("given 1 gallon should return 3.78 litres", () => {
        let gallon = new QuantityMeasurement(1.0, EnumTypes.VOLUME.GALLON);
        let litres = new QuantityMeasurement(3.78, EnumTypes.VOLUME.LITRES);
    ...
    it("given 1 litre should return 1000 ml", () => {
        let litres = new QuantityMeasurement(1.0, EnumTypes.VOLUME.LITRES);
        let millilitres = new QuantityMeasurement(1000, EnumTypes.VOLUME.MILLILITRES);
    ...
    it("given 1 litre and 1000ml should return 2 litres", () => {
        let millilitres = new QuantityMeasurement(1000.0, EnumTypes.VOLUME.MILLILITRES);
        let litres = new QuantityMeasurement(1, EnumTypes.VOLUME.LITRES);
...
describe("test cases for volume in gallons ", () => {
    ...
    it("given 1 kilogram return 1000 grams", () => {
        let kilogram = new QuantityMeasurement(1, EnumTypes.WEIGHT.KILOGRAM);
        let grams = new QuantityMeasurement(1000, EnumTypes.WEIGHT.GRAM);
        let result = Math.round(kilogram.compare(kilogram, grams));
        assert.equal(result, true);
    });

    it("given 1 tonnne return 1000 kilograms", () => {
        let tonne = new QuantityMeasurement(1, EnumTypes.WEIGHT.TONNE);
        let kilograms = new QuantityMeasurement(1000, EnumTypes.WEIGHT.KILOGRAM);
    ...
    it("given 1 tonnne and  1 milliter should return false", () => {
        let tonne = new QuantityMeasurement(1.0, EnumTypes.WEIGHT.TONNE);
        let millilitres = new QuantityMeasurement(1.0, EnumTypes.VOLUME.MILLILITRES);
...
describe("test cases for celcius to farheniet", () => {
    it("given 212 Farheniet and  100 celcius should be equal", () => {
        let celcius = new QuantityMeasurement(100.0, EnumTypes.TEMPERATURE.CELCIUS);
        let farheniet = new QuantityMeasurement(212.0, EnumTypes.TEMPERATURE.FARHENIET);
